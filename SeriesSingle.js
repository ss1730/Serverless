...
var url = "http://gateway.marvel.com/v1/public/characters/{0}/series?limit=100&ts={1}&apikey={2}&hash={3}&offset={4}";
var headers ={
  "x-api-key": "XXXXXX"
}
...
// var PUBLIC_KEY = "e80b6bcf1f06434860c9a3215203ea01";
// var PRIV_KEY = "0263c80cd25d6413fb170fa8d0271ca323966c9b";
// var url = "http://gateway.marvel.com/v1/public/characters/{0}/series?limit=100&ts={1}&apikey={2}&hash={3}";
//
// module.exports.get = (event, context, callback) => {
//
// var url = getUrl.format(event.characterId,ts,PUBLIC_KEY,HASH,event.offset);
//   getComicsCharacter(getUrl);
// };
//
